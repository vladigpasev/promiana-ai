...
const features = [
  ...
  {
    name: 'Генериране на статии с изкуствен интелект',
    description:
      'Нашата платформа предлага възможността да генерирате статиите си с помощта на модела GPT 4. Въведете заглавието на статията и оставете всичко останало на нас.',
  },
  {
